...
class SpatialPolygon : public rclcpp::Node {
   public:
    ...
    typedef message_filters::sync_policies::
        ApproximateTime<sensor_msgs::msg::Image, sensor_msgs::msg::Image, sensor_msgs::msg::CameraInfo, vision_msgs::msg::Detection2DArray>
            syncPolicy;
    std::unique_ptr<message_filters::Synchronizer<syncPolicy>> sync;
    rclcpp::Publisher<geometry_msgs::msg::Polygon>::SharedPtr overlayPub;
