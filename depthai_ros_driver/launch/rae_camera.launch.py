...
def launch_setup(context, *args, **kwargs):
    ...
    return [
        ...
        ComposableNodeContainer(
            ...
            # prefix=['valgrind --tool=memcheck --leak-check=yes --track-origins=yes --log-file=/tmp/log.valgrind'],
...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("params_file", default_value=os.path.join(depthai_prefix, 'config', 'rae_camera.yaml')),
