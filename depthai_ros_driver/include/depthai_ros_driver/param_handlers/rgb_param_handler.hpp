...
class RGBParamHandler : public BaseParamHandler {
   public:
    ...
    ~RGBParamHandler();
    void declareParams(rclcpp::Node* node, std::shared_ptr<dai::node::ColorCamera> color_cam, dai::CameraBoardSocket socket, dai_nodes::sensor_helpers::ImageSensor sensor);
