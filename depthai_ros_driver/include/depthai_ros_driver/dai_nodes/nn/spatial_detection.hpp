   ...
   public:
    ...
    void setupQueues(std::shared_ptr<dai::Device> device) override {
        ...
        if(ph->getParam<bool>("i_enable_passthrough")) {
            ...
            ptQ->addCallback(
                std::bind(sensor_helpers::imgCBIT, std::placeholders::_1, std::placeholders::_2, *ptImageConverter, ptPub, ptInfoMan, false, false));
        }
        ...
        if(ph->getParam<bool>("i_enable_passthrough_depth")) {
            ...
            ptDepthQ->addCallback(std::bind(
                sensor_helpers::imgCBIT, std::placeholders::_1, std::placeholders::_2, *ptDepthImageConverter, ptDepthPub, ptDepthInfoMan, false, false));
        }
    };
