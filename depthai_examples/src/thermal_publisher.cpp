...
int main(int argc, char** argv) {
    ...
    auto node = rclcpp::Node::make_shared("thermal_publisher");
    ...
    auto thermalConverter = std::make_shared<depthai_bridge::ImageConverter>(tfPrefix + "_cam_e_camera_optical_frame", false);
