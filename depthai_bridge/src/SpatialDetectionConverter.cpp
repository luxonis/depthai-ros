...
depthai_ros_msgs::msg::SpatialDetectionArray::SharedPtr SpatialDetectionConverter::toRosMsgPtr(std::shared_ptr<dai::SpatialImgDetections> inNetData){
    depthai_ros_msgs::msg::SpatialDetectionArray::SharedPtr ptr = std::make_shared<depthai_ros_msgs::msg::SpatialDetectionArray>();
